	...
	<div class="container-fluid">
		...
		<div class="card shadow mb-4">
			<div class="card-header py-3">
				...
				<!-- Botão -->
				<a title="Cadastrar novos produtos" href="<?php echo base_url('produtos/add'); ?>" class="btn btn-success btn-sm float-right"><i
					...
					<table class="table table-bordered dataTable " width="100%" cellspacing="0">
						...
						<?php foreach ($produtos as $produto): ?>
							...
							<tr>
								...
								<td class="text-center pr-2"> <?php echo ($produto->produto_estoque_minimo == $produto->produto_qtde_estoque ? '<span class="badge badge-warning btn-sm text-white">'.$produto->produto_qtde_estoque.'</span>' : '<span class="badge badge-info btn-sm text-white">'.$produto->produto_qtde_estoque.'</span>')?></td>
...
<!--***********************************************************************************************************************************-->
								<!-- Operações -->
								<td class="text-right">
									<a title="Editar" href="<?php echo base_url('produtos/edit/' . $produto->produto_id); ?>"
									   class="btn btn-sm btn-primary"><i class="fas fa-edit"></i></a>
									<a title="Excluir " href="javascript(void)" data-toggle="modal" data-target="#produto-<?php echo $produto->produto_id;?>" class="btn btn-sm btn-danger"><i
