			...
			<div class="card-body">
				...
				<form class="user" method="POST" name="form_edit">
					...
					<p><strong><i class="fas fa-clock"></i>&nbsp;&nbsp;Última
							alteração:&nbsp;
						</strong><?php echo formata_data_banco_com_hora($produto->produto_data_alteracao); ?></p>
						...
						<div class="form-group row mb-3">
							...
							<div class="col-md-2">
								...
								<input type="text" class="form-control form-control-user" name="produto_codigo"
									   value="<?php echo $produto->produto_codigo; ?>" readonly="">
							</div>
							...
							<div class="col-md-10">
								...
								<input type="text" class="form-control form-control-user" name="produto_descricao"
									   value="<?php echo $produto->produto_descricao; ?>">
							...
							<div class="col-md-3">
								...
								<select class="custom-select" name="produto_categoria_id">
									...
									<?php foreach ($categorias as $categoria): ?>
										<option value="<?php echo $categoria->categoria_id ?>"<?php echo($categoria->categoria_id == $produto->produto_categoria_id ? 'selected' : '') ?> <?php echo($categoria->categoria_ativa == 0 ? 'disabled' : ''); ?>><?php echo $categoria->categoria_nome; ?></option>
									<?php endforeach; ?>
							...
							<div class="col-md-3">
								...
								<select class="custom-select" name="produto_fornecedor_id">
									...
									<?php foreach ($fornecedores as $fornecedor): ?>
										...
										<option value="<?php echo $fornecedor->fornecedor_id ?>"<?php echo($fornecedor->fornecedor_id == $produto->produto_fornecedor_id ? 'selected' : '') ?> <?php echo($fornecedor->fornecedor_ativo == 0 ? 'disabled' : ''); ?>><?php echo $fornecedor->fornecedor_nome_fantasia; ?></option>
						...
						<div class="form-group row mb-3">
							...
							<div class="col-md-3">
								...
								<input type="text" class="form-control form-control-user money"
									   ...
									   value="<?php echo $produto->produto_preco_custo; ?>">
							...
							<div class="col-md-3">
								...
								<input type="text" class="form-control form-control-user money"
									   ...
									   value="<?php echo $produto->produto_preco_venda; ?>">
							...
							<div class="col-md-3">
								...
								<input type="number" class="form-control form-control-user"
									   ...
									   value="<?php echo $produto->produto_estoque_minimo; ?>">
							...
							<div class="col-md-3">
								...
								<input type="number" class="form-control form-control-user" name="produto_qtde_estoque"
									   value="<?php echo $produto->produto_qtde_estoque; ?>">
