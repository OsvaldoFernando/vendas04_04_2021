	...
	<div class="container-fluid">
		...
		<div class="card shadow mb-4">
			<div class="card-header py-3">
				...
				<!-- Botão -->
				<a title="Cadastrar novo vendedor" href="<?php echo base_url('vendedores/add'); ?>" class="btn btn-success btn-sm float-right"><i
					...
					<table class="table table-bordered dataTable " width="100%" cellspacing="0">
						...
						<?php foreach ($vendedores as $vendedor): ?>
							...
							<tr>
								...
								<td> <?php echo $vendedor->vendedor_telefone ?></td>
...
<!--***********************************************************************************************************************************-->
								<!-- Operações -->
								<td class="text-right">
									<a title="Editar" href="<?php echo base_url('vendedores/edit/' . $vendedor->vendedor_id); ?>"
									   class="btn btn-sm btn-primary"><i class="fas fa-user-edit"></i></a>
									<a title="Excluir " href="javascript(void)" data-toggle="modal" data-target="#vendedor-<?php echo $vendedor->vendedor_id;?>" class="btn btn-sm btn-danger"><i
