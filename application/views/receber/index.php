...
<!--		--><?php //echo date('Y-m-d H:i:s'); ?>
		...
		<div class="card shadow mb-4">
			<div class="card-header py-3">
				...
				<!-- Botão -->
				<a title="Cadastrar nova conta" href="<?php echo base_url('receber/add'); ?>"
					...
					<table class="table table-bordered dataTable " width="100%" cellspacing="0">
						...
						<?php foreach ($contas_receber as $conta): ?>
							...
							<tr>
								...
								<td> <?php echo $conta->cliente_nome; ?></td> <!-- Está vindo do model financeior -->
								<td> <?php echo 'AKZ&nbsp;' . $conta->conta_receber_valor; ?></td>
								...
								<td class="text-right">
									<a title="Editar"
									   href="<?php echo base_url('receber/edit/' . $conta->conta_receber_id); ?>"
							...
							<!-- Logout Modal-->
							<div class="modal fade" id="conta-<?php echo $conta->conta_receber_id; ?>" tabindex="-1"
									...
									<div class="modal-content">
										...
										<div class="modal-footer">
											...
											<a class="btn btn-danger btn-sm"
											   href="<?php echo base_url('receber/del/' . $conta->conta_receber_id); ?>">Sim</a>
										</div>
									</div>
								</div>
							</div>
