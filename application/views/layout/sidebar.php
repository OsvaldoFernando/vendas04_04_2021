	...
	<li class="nav-item">
		...
		<div id="collapseOs" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
			<div class="bg-white py-2 collapse-inner rounded">
				...
				<a title="Gerenciar ordem de serviços" class="collapse-item" href="<?php echo base_url('os') ;?>"><i class="fas fa fa-shopping-basket text-gray-900"></i>&nbsp;&nbsp; Ordem serviços</a>
	...
	<li class="nav-item">
		...
		<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
			<div class="bg-white py-2 collapse-inner rounded">
				...
				<a title="Gerenciar vendedores" class="collapse-item" href="<?php echo base_url('vendedores');?>"><i class="fas fa fa-user-secret text-gray-900"></i>&nbsp;&nbsp;Vendedores</a>
	...
	<li class="nav-item">
		...
		<div id="collapseQuatro" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
			<div class="bg-white py-2 collapse-inner rounded">
				...
				<a title="Gerenciar formas de pagamento" class="collapse-item" href="<?php echo base_url('modulo') ;?>"><i class="fas fa-money-check-alt text-gray-900"></i>&nbsp;&nbsp;Formas de pagamentos</a>
