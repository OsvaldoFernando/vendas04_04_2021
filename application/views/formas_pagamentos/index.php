	...
	<div class="container-fluid">
		...
		<div class="card shadow mb-4">
			<div class="card-header py-3">
				...
				<!-- Botão -->
				<a title="Cadastrar nova forma de pagamento" href="<?php echo base_url('modulo/add'); ?>" class="btn btn-success btn-sm float-right"><i
...
<!--***********************************************************************************************************************************-->
								<!-- Operações -->
								<td class="text-right">
									<a title="Editar" href="<?php echo base_url('formas_pagamentos/edit/' . $forma->forma_pagamento_id); ?>"
									   class="btn btn-sm btn-primary"><i class="fas fa-user-edit"></i></a>
									<a title="Excluir " href="javascript(void)" data-toggle="modal" data-target="#forma-<?php echo $forma->forma_pagamento_id;?>" class="btn btn-sm btn-danger"><i
